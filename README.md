...
serverless create \
  --template-url https://github.com/serverless/examples/tree/v3/aws-node-rest-api-typescript \
  --path crud-service

serverless create \
  --template-url https://github.com/serverless/examples/tree/v3/aws-node-typescript \
  --path aws-node-ts